...
- (void)prepareLayout {
	...
	for (NSInteger section = 0; section < sectionCount; section ++) {
        ...
        CGFloat itemWidth = (self.collectionView.bounds.size.width - contentInset.left - contentInset.right - inset.left - inset.right - (columnCount - 1) * interitemSpacing) / columnCount;
		...
		if (supplementary && footerSize.height > 0) {
            ...
            footer.frame = CGRectMake(contentInset.left, contentHeight, footerSize.width, footerSize.height);
			footer.zIndex = 1;
    ...
    self.contentSize = CGSizeMake(self.collectionView.bounds.size.width - contentInset.left - contentInset.right, contentHeight);
